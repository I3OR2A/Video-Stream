  ...
  <div>
    ...
    >
      <el-form :model="category">
        ...
        <el-input v-model="category.title" placeholder="分类標題"></el-input>
        </el-form-item>
        <el-form-item label="分类子標題" prop="subtitle">
        <el-input v-model="category.subtitle" placeholder="分类子標題"></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    edit(data) {
      ...
      this.$http({
        ...
        this.category.title = data.data.title;
        this.category.subtitle = data.data.subtitle;
    ...
    //修改三级分类数据
    editCategory() {
      var { id, name, icon, title, subtitle } = this.category;
      this.$http({
        url: this.$http.adornUrl("/product/category/update"),
        method: "post",
        data: this.$http.adornData({ id, name, icon, title, subtitle }, false)
      }).then(({ data }) => {
        this.$message({
          message: "菜单修改成功",
          type: "success"
